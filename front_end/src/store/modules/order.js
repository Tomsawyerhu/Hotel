...
import {badOrderAPI, checkInAPI, checkOutAPI, getOrderDetailsAPI, getUserOrdersInCertainHotelAPI} from '@/api/order'
...
const order = {
    ...
    actions: {
        ...
        getOrderDetailsById: async ({state, commit}, orderId) => {
