...
/*!40014 SET @OLD_FOREIGN_KEY_ACHECKS = @@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS = 0 */;
...
/*!40000 ALTER TABLE `Coupon`
    DISABLE KEYS */;
INSERT INTO `Coupon`
VALUES (1, '满500-100优惠', 1, 3, '满减优惠券', 500, 0, 1, NULL, NULL, 100),
       (2, '十一狂欢优惠', 2, 4, '限时优惠券', 0, 9, 0, '2020-10-01', '2020-10-07', 100),
       (3, '满三间8折', 2, 2, '多间优惠券', 0, 8, 1, NULL, NULL, 100);
/*!40000 ALTER TABLE `Coupon`
    ENABLE KEYS */;
COMMIT;
...
/*!40000 ALTER TABLE `Room`
    DISABLE KEYS */;
INSERT INTO `Room`
VALUES (2, 199, 20, 20, 1, '大床房', '无', '2'),
       (3, 299, 30, 30, 1, '双床房', '有', '2'),
       (4, 399, 10, 10, 1, '家庭房', '有', '3'),
       (5, 122, 7, 7, 2, '大床房', '无', '2'),
       (6, 399, 10, 10, 2, '家庭房', '有', '3');
/*!40000 ALTER TABLE `Room`
    ENABLE KEYS */;
COMMIT;
...
VALUES (1, '1@qq.com', '508df4cb2f', '测试一号', '12345678919', 100, 'Client', NULL, NULL, NULL, NULL),
       ...
       (3, '2@qq.com', 'e10adc3949', '测试二号', '12345678911', 100, 'HotelManager', 1, NULL, NULL, NULL),
       (4, '3@qq.com', 'e10adc3949', '测试三号', NULL, NULL, 'Admin', NULL, NULL, NULL, NULL),
       (5, '4@qq.com', 'e10adc3949', '测试四号', NULL, NULL, 'MarketingStaff', NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `User`
    ENABLE KEYS */;
COMMIT;
